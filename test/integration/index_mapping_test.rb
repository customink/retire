  ...
  class IndexMappingIntegrationTest < Test::Unit::TestCase
    ...
    context "Default mapping" do
      ...
      should "create and return the default mapping as a Hash" do
        ...
        assert_equal 'string', index.mapping['mappings']['article']['properties']['title']['type'],  index.mapping.inspect
        assert_nil             index.mapping['mappings']['article']['properties']['title']['boost'], index.mapping.inspect
      end
    end
    ...
    context "Creating index with mapping" do
      ...
      should "create the specified mapping" do
        ...
        # p index.mapping
        assert_equal false, index.mapping['mappings']['article']['_all']['enabled'],               index.mapping.inspect
        assert_equal 2.0,   index.mapping['mappings']['article']['properties']['title']['boost'],  index.mapping.inspect
      end
    end
    ...
    context "Update mapping" do
      ...
      should "update the mapping for type" do
        ...
        assert_equal({ "type" => "string" }, index.mapping['mappings']["article"]["properties"]["body"])
        ...
        # Verify response
        assert_equal( { "type" => "string" }, mapping['mappings']["article"]["properties"]["body"] )
        assert_equal( { "type" => "string" }, mapping['mappings']["article"]["properties"]["title"] )
      end
    ...
    context "Delete mapping" do
      ...
      should "delete the mapping for type" do
        ...
        assert index.mapping['mappings'].empty?, index.response.inspect
      end
    end
